...
export const suites = [
  {
    ...
    commands: [["--test", "tests/apps/job-hunt-hq/snapshot-generations.test.mjs", "tests/apps/job-hunt-hq/draft-storage.test.mjs", "tests/apps/job-hunt-hq/draft-backup.test.mjs", "tests/apps/job-hunt-hq/draft-ui.test.mjs"]],
  },
  {
    id: "panel-ui",
