...
| Video Studio 0.5.1 | `panels/video-studio` | Local video editing, source rough cuts, captions, AI workflows, and fully panel-owned media and voice tools                        |
...
Video Studio 0.5.1 is maintained in `apps/video-studio/` and installed from the
