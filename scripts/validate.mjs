import { runPackageContract as quantLabContract } from "../tests/apps/quant-lab/package-contract.test.mjs";
...
async function validatePackage(packagePath) {
  ...
  if (manifest.id === "quant-lab") await quantLabContract({ root, manifest, html, packagePath });
