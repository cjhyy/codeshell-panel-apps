// Generated from scripts/quant-lab-selection-data-bridge.py; keep in sync.
export const PYTHON_SOURCE = String.raw`"""Read-only optional selection evidence. One JSON request in, one JSON result out.
